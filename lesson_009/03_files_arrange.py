...
class FileSorter:
    ...
    def arrange(self):
        ...
        if os.path.exists(self.dst):
            print(f'Сортировка завершена успешно.', {self.dst})
        else:
            print(f'Проверьте пути к каталогам.', {self.src}, {self.dst})


if __name__ == '__main__':
    src_dir = 'C:\\Users\\iamalreadydead\\Pictures\\flat'
    dst_dir = 'C:\\Users\\iamalreadydead\\Pictures\\flat\\sorted'
