...
summary_height = (my_family_height[0][1]
                  + my_family_height[1][1]
                  + my_family_height[2][1])
print("Рост семьи -", summary_height, "см")

# или правильнее будет print("Рост семьи -", my_family_height[0][1] + my_family_height[1][1] + my_family_height[2][1], "см") ?
# тут не принципиально, ты сделал правильно
