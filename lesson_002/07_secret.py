...
#TODO   4е и 5е слова нужно получить за 1 срез - так и не понял как за один срез, они в разных элементах списка

#   Если нужны вычисления и разные пробы - делайте это в консоли пайтона, тут нужен только результат

print(secret_message[0][3:4:1], secret_message[1][9:13:1], secret_message[2][5:15:2], secret_message[3][12:6:-1], secret_message[4][20:15:-1])
