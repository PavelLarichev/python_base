...
# 4е и 5е слова нужно получить за 1 срез - так и не понял как за один срез, они в разных элементах списка
# - Тут имелось ввиду за один срез, н ов отдельности, просто некоторые сначала получают срез, а потом делают инверсию)

#   Если нужны вычисления и разные пробы - делайте это в консоли пайтона, тут нужен только результат

print(secret_message[0][3:4:1],
